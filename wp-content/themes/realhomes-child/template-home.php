...
AIzaSyCi-_XVw7BJMrfzGb19jtsQFmJgg82hyHw
*/
...
/*
 $home_args['orderby'] = 'meta_value';
								 $home_args['meta_key'] = 'REAL_HOMES_property_order';
                ...
                <section class="hampton-section clearfix">
                    <div class="narrative">
                        <h3>About Hampton Roads</h3>
                    </div>
                    <?php 
                                $id=9895; 
                                $post = get_post($id);
