...
if ( is_page_template( 'template-dsIDX.php' ) ) {
	// Returns true when 'about.php' is being used.
} else {
              //  wp_register_script('google-map-api', '//maps.google.com/maps/api/js?key=AIzaSyAmhlHU-FbkgZrU_4QLaCTripBAXHNm_I8&sensor=true', array(), '', false);
...
if(!function_exists('edit_form_city_options')){

    function edit_form_city_options( $property_id, $taxonomy_name ){
        ...
        generate_id_based_hirarchical_options("property-city", $property_city_terms, $existing_term_id );
