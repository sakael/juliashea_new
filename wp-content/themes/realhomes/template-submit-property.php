                                                        ...
                                                        <div class="agent-options">
                                                            ...
                                                            <select name="agent_id" id="agent-selectbox">
                                                                ...
                                                                foreach ( $agents as $agent ) :
                                                                    ?><option value="<?php echo $agent->ID; ?>" <?php if( isset($post_meta_data['REAL_HOMES_agents']) && ($post_meta_data['REAL_HOMES_agents'][0] == $agent->ID ) ){ echo "selected"; } ?>><?php echo $agent->post_title; ?></option><?php
                                                                endforeach;
                                                                ?>
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="form-option">
                                                ...
                                                <div class="agent-options">
                                                    ...
                                                    <select name="agent_id" id="agent-selectbox">
                                                        ...
                                                        $agents = get_posts( $agents_args );
                                                        foreach ( $agents as $agent ) :
                                                            ?><option value="<?php echo $agent->ID; ?>"><?php echo $agent->post_title; ?></option><?php
                                                        endforeach;
                                                        ?>
                                                    </select>
                                                </div>
