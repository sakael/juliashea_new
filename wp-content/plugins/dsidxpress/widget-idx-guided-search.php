		...
		if($searchOptions["show_mlsnumber"] == "yes") {
			echo <<<HTML
				<div class="dsidx-resp-area">
					...
					<div id="dsidx-autocomplete-spinner-guided-search" class="dsidx-autocomplete-mls-number-spinner" style="display:none;"><img src="http://api-idx.diversesolutions.com/Images/dsIDXpress/loadingimage.gif"></div>
				</div>
HTML;
		}
		echo <<<HTML
