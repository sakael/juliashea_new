...
var dsidxMultiListings = (function() {
	...
	returnObj = {
		init: function() {
			...
			var linkId, area, minPrice, maxPrice, checkedListingStatuses, checkedPropertyTypes, sortColumn, sortDirection, count, listTabAlignment, shortcodeResultsView;
		...
		insert: function() {
			...
			var minPrice, maxPrice, minBeds, maxBeds, minBaths, maxBaths, minDOM, maxDOM, minYear, maxYear, minImpSqFt, maxImpSqFt, minLotSqFt, maxLotSqFt, agentid, officeid, checkedListingStatuses, checkedPropertyTypes, sortOrder, count, listTabAlignment, shortcodeResultsView;
