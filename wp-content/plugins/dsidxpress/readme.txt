...
Tags: IDX, MLS, real estate, realtor, housing, listings, SEO, CRM, lead capture, mobile friendly, customizable, diverse solutions, market leader, ds, marketleader, rets, idxpress, dsidxpress
...
== Description ==
**Get More Visitors & Leads From Your WordPress Website**

With dsIDXpress, you can easily add SEO-friendly MLS listings to your WordPress website to attract more visitors. Use shortcodes, widgets, and custom pages to display powerful MLS search tools that will keep visitors on your website looking at homes for sale. Lead capture tools, like forms for scheduling showings and saving property searches, will help you turn these visitors into leads. Daily or weekly listing alerts will assist with converting your leads into clients.

Why dsIDXpress is the right IDX solution for your website:
*   **Detailed, up-to-date listings:** Listing details pulled straight from your MLS's IDX feed, plus information about local schools, lists of similar and recently-sold homes, and bird's-eye and street view maps.
*   **Powerful MLS search widgets:** Visitors can easily find MLS listings on your website with powerful map search widgets, slideshows of highlighted properties, and more.
*   **Lead capture tools:** Turn visitors into leads with forms for scheduling showings, website registration, saving searches, and contacting you for more information.
*   **Search engine friendly:** Bring in more visitors from search engines with unique indexable listing pages, Google XML sitemaps, and optimized page titles.
*   **Install and set up in minutes:** Installing and setting up the plugin is fast and simple, regardless of your web development experience. 
*   **Optimized for mobile devices:** The plugin's mobile-friendly design ensures smartphone-using visitors will have a good experience on your website.
*   **Extensively customizable:** Easily customize IDX listing details and the styling of MLS search forms and widgets.
*   **Integrated contact management:** A built-in CRM stores, organizes, and tracks your leads and shows their saved searches, favorite listings, and listing search history.

**700+ IDX Feeds Across the U.S. and Canada**

The IDX feeds of 700+ MLSs across the U.S. and Canada can be used with dsIDXpress - the best MLS coverage in the industry!

**See dsIDXpress in Action**

Test drive dsIDXpress on your WordPress website today! **[Get a free trial](https://www.diversesolutions.com/product/wordpress-idx/)** or call us at 800-491-3608.

**[View a live demo of dsIDXpress >>](https://www.diversesolutions.com/wordpress-demo/)**

== Installation ==
**Installation**

Install dsIDXpress on your website like you would install any other WordPress plugin.

Install via the WordPress admin area:
1. In the WordPress admin area, visit "Plugins" > "Add New."
2. Search for "dsIDXpress" using the search bar.
...
Once installed, dsIDXpress must be activated by entering the activation key for your free trial or paid subscription. Simply visit the "IDX" page linked to in the WordPress admin area sidebar and enter the activation key into the text box.

**Don't have an activation key?** Contact us to get one for your free trial or paid subscription:
[Contact Us](https://www.diversesolutions.com/contact/)
(800) 978-5177
sales@diversesolutions.com

== Frequently Asked Questions ==

= Can I get a free trial of dsIDXpress? =

Yes, we encourage you to test drive dsIDXpress on your website. [Request your free trial here](https://www.diversesolutions.com/product/wordpress-idx/) or by calling us at 800-491-3608.

The free trial uses sample IDX data to demonstrate how easy it is to add MLS listings to real estate websites using dsIDXpress.

= Are listings from my MLS available with dsIDXpress? =

Visit the [MLS Coverage page](https://www.diversesolutions.com/idx-coverage/) on our website to see if your MLS's IDX feed is available with dsIDXpress. Diverse Solutions has the largest MLS coverage in the industry, so there is a good chance it will be available. If it isn't, call us at (800) 978-5177 and we will inquire about adding it to our coverage area.

= Which WordPress themes should dsIDXpress be used with? =

The dsIDXpress plugin is designed to be compatible with any WordPress website that is self hosted and uses WordPress 2.8 or above. You do not need to purchase or use any one specific theme to use dsIDXpress.

= How much does dsIDXpress cost? =

[Learn about the different features and pricing of the Basic and Pro dsIDXpress subscriptions.](https://www.diversesolutions.com/product/wordpress-idx/)

= Can I use dsIDXpress without being a member of an MLS? =

No. Due to the rules of the MLSs whose IDX feeds are available for dsIDXpress, we can only provide activation keys to their members. 

= Can I use dsIDXpress without an activation key if I'm a member of an MLS? =

No. We require purchasing a dsIDXpress subscription in order to get an activation key. 

= How can I learn more about dsIDXpress? =

1. [Visit our website for more FAQs about dsIDXpress.](https://www.diversesolutions.com/faq/)
2. [Learn about the different features and pricing of the Basic and Pro dsIDXpress subscriptions.](https://www.diversesolutions.com/product/wordpress-idx/) 

== Screenshots == 

1. The listing photo slideshow and some of the property details that are displayed on individual listings' pages.
2. Listings can be displayed in a grid, on a map, or in a list.
3. The dsIDXpress plugin is highly customizable. Compare this image with the previous screenshot.
4. Three of the ways listings can be displayed on your website with MLS search widgets.
5. Create SEO-friendly pages displaying specific types of listings using filters you select.
