...
if($_POST['Delete'])
{
	if(!empty($_POST['del_rec']))
	{
		...
		$obj->qUpdate(TABLE_SURVEY_QUESTION,"survey_question_status='D'","survey_question_id in(".$ids.")");
...
$sql=$obj->selectData(TABLE_QUESTION." as a,".TABLE_SURVEY." as b,".TABLE_SURVEY_QUESTION." as c","a.question_title,a.question_type,b.survey_title,c.*","question_status='A' and survey_status='A' and a.question_id=c.question_id and b.survey_id=c.survey_id and survey_question_status='A'".$cond,2,"survey_id,c.question_order");
//echo $obj->getQuery();
          ...
          <td align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td align="left" valign="top" class="inner"><table width="100%"  border="0" cellpadding="0" cellspacing="2">
                  <tr>
                    <td height="25" align="left" valign="middle" class="td_heading">Question to Survey:</td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          <td height="25" align="left" valign="top"><table width="100%"  border="0" cellspacing="2" cellpadding="0">
                              <tr>
                                ...
                                <td align="center" valign="middle"><a href="manage_survey_question.php" target="_self" class="blue_text"><b>Assign Question </b></a></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><form name="form1" method="post" action="">
                              <table width="100%"  border="0" cellpadding="2" cellspacing="1" >
								...
								<tr class="tr_bg">
                                  ...
                                  <td align="center" valign="middle"><input type="checkbox" name="del_rec[]" value="<?=$row['survey_question_id']?>"></td>
                                </tr>
								<? }?>
                                <tr class="tr_bg">
