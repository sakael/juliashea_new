...
if($_POST['Submit'])
{
	...
	for($i=0;$i<count($question_id);$i++)
	{
		...
		$row=$obj->selectData(TABLE_SURVEY_QUESTION,"","survey_id='".$arr['survey_id']."' and question_id='".$arr['question_id']."'",1);
		if($row==0)
		{
			$arr['survey_question_crdt']=date("Y-m-d H:i:s");
			$arr['question_order']=$obj->getQuesOrder($arr['survey_id']);
			$q_id=$obj->insertData(TABLE_SURVEY_QUESTION,$arr);
		}
	}
	$obj->reDirect("list_survey_question.php?survey_id=".$survey_id);
}
$caption='Assign';
?>
<html>
          ...
          <td align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td align="left" valign="top" class="inner"><table width="100%"  border="0" cellpadding="0" cellspacing="2">
                <tr>
                  <td height="25" align="left" valign="middle" class="td_heading"><?=$caption?> Question to Survey:</td>
                </tr>
                <tr>
                      ...
                      <table width="100%" border="0" cellspacing="1" cellpadding="2">
                        ...
                        <tr class="tr_bg">
                          ...
                          <td align="left" valign="top"><select name="question_id[]" size="10" multiple id="question_id">
                            <?=$obj->questionList(""," order by question_type")?>
                          </select></td>
                        </tr>
                        <tr class="tr_bg">
