...
if($_POST['Delete'])
{
	if(!empty($_POST['del_rec']))
	{
		...
		$obj->qUpdate(TABLE_INDUSTRY,"industry_status='D'","industry_id in(".$ids.")");
...
$sql=$obj->selectData(TABLE_INDUSTRY,"","industry_status='A'",2);
          ...
          <td align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td align="left" valign="top" class="inner"><table width="100%"  border="0" cellpadding="0" cellspacing="2">
                  <tr>
                    <td height="25" align="left" valign="middle" class="td_heading">Industry :</td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          <td height="25" align="left" valign="top"><table width="100%"  border="0" cellspacing="2" cellpadding="0">
                              <tr>
                                ...
                                <td align="center" valign="middle"><a href="manage_industry.php" target="_self" class="blue_text"><b>Add</b></a></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><form name="form1" method="post" action="">
                              <table width="100%"  border="0" cellpadding="2" cellspacing="1" >
                                <tr align="center" valign="middle">
                                  <td width="80%" height="25" align="left" valign="middle" class="td_heading">Industry title </td>
								...
								<tr class="tr_bg">
                                  ...
                                  <td align="center" valign="middle"><a href="manage_industry.php?industry_id=<?=$row['industry_id']?>" target="_self" class="blue_link">Edit</a></td>
                                  <td align="center" valign="middle"><input type="checkbox" name="del_rec[]" value="<?=$row['industry_id']?>"></td>
                                </tr>
								<? }?>
                                <tr class="tr_bg">
