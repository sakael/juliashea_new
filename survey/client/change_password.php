...
if($_POST['Submit'])
{
	$sql=$obj->selectData(TABLE_CLIENT,"","client_password='".trim($_POST['client_passo'])."' and client_id='".$cur_client_id."'",1);
	if($sql==0) $msg='Please enter correct current password!';
	else
	{
		$obj->updateData(TABLE_CLIENT,array("client_password"=>$_POST['client_password']),"client_id='".$cur_client_id."'");
...
function chkBlank()
{
	if(isWhitespace(document.form1.client_passo.value)==true)
	{
		alert("Please enter old password!");
		document.form1.client_passo.focus();
		return false;
	}	
	if(isWhitespace(document.form1.client_password.value)==true)
	{
		alert("Please enter new password!");
		document.form1.client_password.focus();
		return false;
	}
	if(isWhitespace(document.form1.client_passwordc.value)==true)
	{
		alert("Please re-enter new password!");
		document.form1.client_passwordc.focus();
		return false;
	}
	if(document.form1.client_password.value!=document.form1.client_passwordc.value)
	{
          ...
          <td align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td align="left" valign="top" class="inner"><table width="100%"  border="0" cellpadding="0" cellspacing="2">
                <tr>
                  <td height="25" align="left" valign="middle" class="td_heading">Change your password  :</td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="border2"><form name="form1" method="post" action="" onSubmit="return chkBlank();">
                      <table width="100%" border="0" cellspacing="1" cellpadding="2">
                        ...
                        <tr class="tr_bg">
                          ...
                          <td align="left" valign="middle"><input name="client_passo" type="password" class="input" id="client_passo" size="30"></td>
                        </tr>
                        <tr class="tr_bg">
                          <td height="25" align="left" valign="top" class="black_text">Enter new password </td>
                          <td align="center" valign="top" class="black_text">:</td>
                          <td align="left" valign="top"><input name="client_password" type="password" class="input" id="client_password" size="30"></td>
                        </tr>
						<tr class="tr_bg">
                          <td height="25" align="left" valign="top" class="black_text">Re-enter new password</td>
                          <td align="center" valign="top" class="black_text">:</td>
                          <td align="left" valign="top"><input name="client_passwordc" type="password" class="input" id="client_passwordc" size="30"></td>
                        </tr>
                        <tr class="tr_bg">
